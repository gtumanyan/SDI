...
// version_template.h
#define APPTITLE            L"Snappy Drivers Installer " TEXT(SDI_VERSIONINFO) " " TEXT(SDI_DEBUG)
#define VER_MARKER          "SDW"
#define VER_STATE           0x102
#define VER_INDEX           0x205
#ifdef _WIN64
#define SDI_ARCHITECTURE _T("64-bit")
#else
#define SDI_ARCHITECTURE _T("32-bit")
#endif
#ifdef _DEBUG
#define SDI_DEBUG _T(" debug")
#else
#define SDI_DEBUG _T("")
#endif
#include "version.h"
