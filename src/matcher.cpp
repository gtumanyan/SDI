...
{
    "nt.5",  "ntx86.5",  "ntamd64.5"  ,// 2000
    "nt.5.0","ntx86.5.0","ntamd64.5.0",// 2000
    "nt.5.1","ntx86.5.1","ntamd64.5.1",// XP
    "nt.5.2","ntx86.5.2","ntamd64.5.2",// Server 2003
    "nt.6",  "ntx86.6",  "ntamd64.6"  ,// Vista
    "nt.6.0","ntx86.6.0","ntamd64.6.0",// Vista
    "nt.6.1","ntx86.6.1","ntamd64.6.1",// 7
    "nt.6.2","ntx86.6.2","ntamd64.6.2",// 8
    "nt.6.3","ntx86.6.3","ntamd64.6.3",// 8.1

    "nt.10.0","ntx86.10.0","ntamd64.10.0",// 10
    "nt.10.0.1","ntx86.10.0.1","ntamd64.10.0.1",// 10 server
  	"nt",    "ntx86",    "ntamd64",    
    "nt..",  "ntx86..",  "ntamd64..",  
};
