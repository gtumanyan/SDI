...
//static void myunexpected()    спецификация исключений есть маразм и оберегает неокрепшие умы от всякого, но если очень хочется, то есть общеизвестный недокументированный ключ: /d1ESrt
//{
...
{
//    std::set_unexpected(myunexpected); спецификация исключений есть маразм и оберегает неокрепшие умы от всякого, но если очень хочется, то есть общеизвестный недокументированный ключ: /d1ESrt 
